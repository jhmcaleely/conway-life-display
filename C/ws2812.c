...
int main() {
    ...
    bool success = pio_claim_free_sm_and_add_program_for_gpio_range(&ws2812_program, &pio, &sm, &offset, WS2812_GPIO, 1, true);
    hard_assert(success);

    ws2812_program_init(pio, sm, offset, WS2812_GPIO, 800000, IS_RGBW);
